...
export declare const MATCHUP_MOBILE_CLASSNAMES: string[];
export declare const MATCHUP_MOBILE_STYLE: React.CSSProperties;
export declare type MatchupMobileProps = {
...
export declare const MatchupMobile: FC<MatchupMobileProps>;
