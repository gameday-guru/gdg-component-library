...
export declare const OPTION_CLASSNAMES: string[];
export declare const OPTION_STYLE: React.CSSProperties;
export declare type OptionProps = React.HTMLProps<HTMLOptionElement> & {
