...
import { MyBrackets as MyBracketsPage } from '../../pages/bracket/MyBrackets';
...
export const MyBrackets : FC<MyBracketsProps>  = (props) =>{
    ...
    return (
        <MyBracketsPage
        onBracketIdClick={async (id : string)=>navigate(`/brackets/${id}`)}
        teams={teams}
        brackets={brackets}
