...
export const FILTER_MODAL_MOBILE_CLASSNAMES : string[] = [ 
    "p-4",
    "rounded",
    "gap-2"
];
export const FILTER_MODAL_MOBILE_STYLE : React.CSSProperties = {
    height : "300px",
    width : "100%",
    overflowY : "scroll",
};

export type FilterModalMobileProps = {
...
export const FilterModalMobile : FC<FilterModalMobileProps>  = (props) =>{
    ...
    const InnerModal = (
            ...
            <div
            className={[...!props.overrideClasses ? FILTER_MODAL_MOBILE_CLASSNAMES : [], ...props.classNames||[]].join(" ")}
            style={{...!props.overrideStyle ? FILTER_MODAL_MOBILE_STYLE : {}, ...props.style}}>
