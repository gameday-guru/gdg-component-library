...
export const MENS_COLLEGE_BASKETBALL_MOBILE_HEADER_INNER_CLASSNAMES : string[] = [ 
    "grid",
    "p-4",
    "gap-2",
];
export const MENS_COLLEGE_BASKETBALL_MOBILE_HEADER_INNER_STYLE : React.CSSProperties = {
    // justifyItems : "center"
};



export type MensCollegeBasketballMobileHeaderProps = {
...
export const MensCollegeBasketballMobileHeader : FC<MensCollegeBasketballMobileHeaderProps>  = (props) =>{
    ...
    return (
        <Wrapper
            ...
            emphasis={400}
            classNames={[...!props.overrideClasses ? MENS_COLLEGE_BASKETBALL_MOBILE_HEADER_CONTAINER_CLASSNAMES : [], ...props.classNames||[]]}
            style={{...!props.overrideStyle ? MENS_COLLEGE_BASKETBALL_MOBILE_HEADER_CONTAINER_STYLE : {}, ...props.style}}>
            <div
            className={[...!props.overrideClasses ? MENS_COLLEGE_BASKETBALL_MOBILE_HEADER_INNER_CLASSNAMES : [], ...props.classNames||[]].join(" ")}
            style={{...!props.overrideStyle ? MENS_COLLEGE_BASKETBALL_MOBILE_HEADER_INNER_STYLE : {}, ...props.style}}>
                ...
                <div className="flex hover-underline" style={{
                        alignContent : "center",
                        alignItems : "center",
                        margin : "0 auto"
                }}>
