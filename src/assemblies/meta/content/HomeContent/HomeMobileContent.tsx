...
export const HOME_MOBILE_CONTENT_CONTAINER_CLASSNAMES : string[] = [ ];
export const HOME_MOBILE_CONTENT_CONTAINER_STYLE : React.CSSProperties = {
};

export const HOME_MOBILE_CONTENT_INNER_CLASSNAMES : string[] = [ ];
export const HOME_MOBILE_CONTENT_INNER_STYLE : React.CSSProperties = {
    
};

export type HomeMobileContentProps = {
...
export const HomeMobileContent : FC<HomeMobileContentProps>  = (props) =>{

    return (
        <Wrapper
            viusage={props.viusage||"backdrop"}
            classNames={[...!props.overrideClasses ? HOME_MOBILE_CONTENT_CONTAINER_CLASSNAMES : [], ...props.classNames||[]]}
            style={{...!props.overrideStyle ? HOME_MOBILE_CONTENT_CONTAINER_STYLE : {}, ...props.style}}>
            <div
            className={[...!props.overrideClasses ? HOME_MOBILE_CONTENT_INNER_CLASSNAMES : [], ...props.classNames||[]].join(" ")}
