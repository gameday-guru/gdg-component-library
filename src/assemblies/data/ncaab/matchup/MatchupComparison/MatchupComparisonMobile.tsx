...
export const MATHCUP_COMPISON_MOBILE_CLASSNAMES : string[] = [
    "grid",
    "p-4",
    "rounded-lg",
    "gap-4"
];
export const MATHCUP_COMPISON_MOBILE_STYLE : React.CSSProperties = {
};

export type MatchupComparisonMobileProps = {
...
export const MatchupComparisonMobile : FC<MatchupComparisonMobileProps>  = (props) =>{


    return (
        <Wrapper
        viusage='wrap'
        classNames={[...!props.overrideClasses ? MATHCUP_COMPISON_MOBILE_CLASSNAMES : [], ...props.classNames||[]]}
        style={{...!props.overrideStyle ? MATHCUP_COMPISON_MOBILE_STYLE : {}, ...props.style}}>
            <div>
                <MatchupHeadline 
