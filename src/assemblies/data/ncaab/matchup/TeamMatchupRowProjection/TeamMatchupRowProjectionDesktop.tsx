...
export const TEAM_MATCHUP_ROW_PROJECTION_DESKTOP_CONTAINER_CLASSNAMES : string[] = [ 
    "p-4",
    "rounded-lg",
    "gap-2"
];
export const TEAM_MATCHUP_ROW_PROJECTION_DESKTOP_CONTAINER_STYLE : React.CSSProperties = {
};

export const TEAM_MATCHUP_ROW_PROJECTION_DESKTOP_INNER_CLASSNAMES : string[] = [ 
    "grid",
    "gap-2"
];
export const TEAM_MATCHUP_ROW_PROJECTION_DESKTOP_INNER_STYLE : React.CSSProperties = {
    gridTemplateColumns : "3fr 1fr",
    gridTemplateRows : "1fr"
};

export type TeamMatchupRowProjectionDesktopProps = {
...
export const TeamMatchupRowProjectionDesktop : FC<TeamMatchupRowProjectionDesktopProps>  = (props) =>{
    ...
    return (
        <Button
            ...
            style={{...!props.overrideStyle ? TEAM_MATCHUP_ROW_PROJECTION_DESKTOP_CONTAINER_STYLE : {}, ...props.style}}>
            <div>
                {_dateString}
            </div>
            <div
            className={[...!props.overrideClasses ? TEAM_MATCHUP_ROW_PROJECTION_DESKTOP_INNER_CLASSNAMES : [], ...props.classNames||[]].join(" ")}
