...
export type NcaabMensGameLogProps = {
...
export const NcaabMensGameLog : FC<NcaabMensGameLogProps>  = (props) =>{
    ...
    const gameProjections = (props.top25Games||Array(10).fill(MockProjectedGame))
    .map((entry, i)=>{
        return (
